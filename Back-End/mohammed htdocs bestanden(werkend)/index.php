    ...
    <div class="login-card-container">
        <div class="login-card">
            <div class="login-card-logo">
                <img src="logofashion.png" alt="logo">
            </div>
            <div class="login-card-header">
                <h1>Sign In</h1>
                <div>Please login to use the platform</div>
            </div>
            <form class="login-card-form" action="login.php"  method="post" enctype=>
                <div class="form-item">
                    <span class="form-item-icon material-symbols-rounded">mail</span>
                    <input type="text" placeholder="Enter Email" id="email" name="email" autofocus required>
                </div>
                <div class="form-item">
                ...
                <button type="submit" id="btn" value="Login" name = "submit" >
                Sign In
                </button>
            </form>
